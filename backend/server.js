...
// TEMP DEBUG — dry-run the AI listing generator against a real product to
// confirm tags come through. Remove after verification.
app.get('/api/_debug-listing/:id', async (req, res) => {
  try {
    ...
    res.json({ before: product, after: result });
  } catch (err) {
